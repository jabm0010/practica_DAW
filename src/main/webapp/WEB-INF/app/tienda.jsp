                        ...
                        <c:forEach var="o"  items="${enOferta}">
                            <a href="#" class="list-group-item">
                                <div class="media col-md-4">
                                    ...
                                    <img class="media-object img-rounded img-responsive"src="${pageContext.request.contextPath}/imgs/juego${o.videojuegoID}.png"  alt="placehold.it/350x250" >
                    ...
                    <c:forEach var="m"  items="${masVendidos}">
                        ...
                        <div class="col-xs-2 col-md-2">
                            <div class="card card-outline-primary mb-3 text-center">
                                ...
                                <img class="card-img-top" src="${pageContext.request.contextPath}/imgs/juego${m.videojuegoID}.png" width="400" height="300" alt="Card image cap">
