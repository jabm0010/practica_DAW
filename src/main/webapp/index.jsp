            ...
            <div class="columna-derecha">
              ...
              <form class="form-horizontal" role="form" action="comunidad.jsp" method="POST">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" id="reg_email" placeholder="Introduce tu email">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="reg_usuario">Usuario:</label>
                  <div class="col-sm-10">
                    <input type="email" class="form-control" id="reg_usuario" placeholder="Introduce tu nombre">
                  </div>
                </div>
                <div class="form-group">
